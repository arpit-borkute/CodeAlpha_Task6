...
public final class GoogleTranslate { // Class marked as final since all methods are static
	...
	private static String generateURL(String sourceLanguage, String targetLanguage, String text)
		...
		// Other dt parameters request additional information such as pronunciation, and
		// so on.
	...
	private static String urlToText(URL url) throws IOException {
		...
		// Adding header for user agent is required. Otherwise, Google rejects the
		// request
		urlConn.addRequestProperty("User-Agent",
				"Mozilla/5.0 (Windows NT 6.1; WOW64; rv:2.0) Gecko/20100101 Firefox/4.0");
		Reader r = new java.io.InputStreamReader(urlConn.getInputStream(), Charset.forName("UTF-8"));// Gets Data
																										// Converts to
																										// string
